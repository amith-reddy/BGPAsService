...
@Stepwise
class ConfigWithAuthSpec extends GebReportingSpec {
	...
	def "Enter Scheduler3 details"() {
		when:
			...
			$('#activationCronDivId').find('.jqCron .jqCron-container .jqCron-blocks .jqCron-dow .jqCron-selector.jqCron-selector-1 .jqCron-selector-list li').eq(0).click()
			...
			$('#activationCronDivId').find('.jqCron .jqCron-container .jqCron-blocks .jqCron-time .jqCron-selector.jqCron-selector-2 .jqCron-selector-list li').eq(0).click()
			...
			$('#deactivationCronDivId').find('.jqCron .jqCron-container .jqCron-blocks .jqCron-dow .jqCron-selector.jqCron-selector-1 .jqCron-selector-list li').eq(4).click()
			...
			$('#deactivationCronDivId').find('.jqCron .jqCron-container .jqCron-blocks .jqCron-time .jqCron-selector.jqCron-selector-2 .jqCron-selector-list li').eq(59).click()
