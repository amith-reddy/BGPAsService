...
<html>
	...
	<body>
		<a href="#create-protocol" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div id='cssmenu'>
		<ul>
		...
		<div id="create-protocol" class="content scaffold-create" role="main">
			...
			<g:form id="protocolform" url="[resource:protocolInstance, action:'save']" >
				<fieldset class="form">
