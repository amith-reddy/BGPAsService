...
<html>
	<head>
		...
		<script src="${resource(dir: 'js', file: 'SchedulerEdit.js')}"></script>
	</head>
	<body>
		<a href="#edit-scheduler" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div id='cssmenu'>
		<ul>
		...
		<div id="edit-scheduler" class="content scaffold-edit" role="main">
			...
			<g:form id="schedulerform" url="[resource:schedulerInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${schedulerInstance?.version}" />
				<fieldset class="form">
