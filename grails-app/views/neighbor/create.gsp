...
<html>
	...
	<body>
		<a href="#create-neighbor" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div id='cssmenu'>
		<ul>
		...
		<div id="create-neighbor" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:neighborInstance, action:'save']" >
				<fieldset class="form">
